    ...
    function cardProduto(p){
      ...
      el.innerHTML = `
        ...
        <div class="card-content">
          ...
          <div class="actions">
            <button class="btn" style="background: #6ee7f9; color: rgba(16,24,43,.75);" onclick='addCarrinho(${JSON.stringify(p.id)})'>Adicionar</button>
            <button class="btn" style="background: #6ee7f9; color: rgba(16,24,43,.75);" onclick='comprarAgora(${JSON.stringify(p.id)})'>Comprar</button>
          </div>
        </div>`;
      return el;
    }
